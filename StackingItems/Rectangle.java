...
public class Rectangle{
    ...
    /**
     * posiciona la esquina superior derecha del cuadrado en donde se desee
     * de manera vertical
     * 
     * @param positionX dice cual es la posicion en la que se desea la
     * esquina
     */
    public void positionHorizontal(int positionX){
        erase();
        xPosition = positionX;
        draw();
    }
     ...
     * 
     * @param positionY dice cual es la posicion en la que se desea la
     * esquina
     */
    public void positionVertical(int positionY){
        erase();
        yPosition = positionY;
        draw();
    }
