 ...
 */
public final class Fearful extends Lid
{
    
    /**
     * Constructor for objects of class Fearful
     */
    public Fearful(int number, int posicionX, int posicionY, String color)
    {
    ...
    protected void bodyBuilder(){
        ...
        body.add(new Circle(posXBase, posYBase, PX_X_CM, "black"));
    }
    ...
    public void eliminate(){
        eliminate = !(getNumber() == getBase().getNumber());   
    }
    ...
    public boolean canEliminate(){
        return getNumber() == getBase().getNumber();   
    }
